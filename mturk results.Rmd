...
```{r mutate data into more suitable modeling structure and fit model1}
library(dplyr)
library(tidyr)
library(stringr)
library(forcats)
...
```{r get and plot model predictions}
...
```{r fit and generate plot for model2}
...
```{r worker-level plot for model 2}
